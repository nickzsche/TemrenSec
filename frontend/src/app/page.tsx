...
const features = [
  { icon: Shield, title: '89 Security Scanners', desc: 'Full OWASP Top 10 2025 coverage: SQL Injection, XSS, SSRF, IDOR, SSTI, NoSQL, CORS, Secret Scanning, Proof-Based Verification, and more.' },
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-10">
            Self-hosted OWASP Top 10 security scanner. 89 detectors, WAF bypass, real-time dashboard, and enterprise integrations — all open source.
          </p>
